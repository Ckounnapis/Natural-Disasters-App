...
public class AppController {
	...
	/*public void printLoadedFile(String fileName, String delimiter) throws FileNotFoundException, IOException {
        List<IMeasurementVector> measurementVectors = null;
        measurementVectors = mainController.load(fileName, delimiter);
        // Iterate over the loaded measurement vectors and print their content
        for (IMeasurementVector measurementVector : measurementVectors){
                System.out.println(measurementVector.toString());
        }
